...
class RunRandomizedSearchCV(luigi.Task):
    def output(self):
        return luigi.LocalTarget("/Users/ryanmiller/data science/capstone_1_project/data/RandomizedSearch_finaltweak2.txt")
...
#                        }
        params_opt =  {
                        ...
                        'n_estimators': randint(2400, 3000),
                        'num_leaves': randint(30, 40),
                        'max_depth': [8, 16, None],
                        'colsample_bytree' : uniform(loc=0.3, scale=.1),
        ...
        f = open('/Users/ryanmiller/data science/capstone_1_project/data/CVresults.pckl', 'wb')
